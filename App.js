...
import { StyleSheet, Text, Button, View, FlatList, ScrollView, Alert } from "react-native";
import YoutubePlayer from "react-native-youtube-iframe";

const App = () => (
  <ScrollView contentContainerStyle={{marginTop: 50}}>
    <Text style={{fontSize: 40, justifyContent:'center', fontWeight:'bold'}}>Curriculum</Text>
    <Text style={{fontSize: 20}}>Introduction to React Native</Text>
    <YoutubePlayer
        height={300}
        videoId={"ur6I5m2nTvk"}
      />
    <Button title="Link" onPress={() => Alert.alert('Simple Button pressed')}/>
